...
def addThesaurus(tree, xpath, help_thesaurus, thesaurus, thesaurus_rows):
    ...
    thesaurus_datype_codelist = thesaurus.row(thesaurus_rows["datetypecodelist"])
...
# Associate columns and headers
    ...
    thesaurus_rows = {"name": thesaurus_name_row, "link": thesaurus_link_row, "version": thesaurus_version_row, "datetype": thesaurus_datype_row, "date": thesaurus_date_row, "datetypecodelist": thesaurus_datype_codelist_row}
    ...
    for row in range(fields_row_start, md_fields.nrows):
        ...
        for col in range(fields_col_start, md_fields.ncols):
            ...
            try:
                ...
                if help_thesaurus:
                    addThesaurus(tree, xpath, help_thesaurus, thesaurus, thesaurus_rows)
